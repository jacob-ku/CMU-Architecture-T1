                         ...
                         double *Azimuth21)
{
    ...
    a = 1.0 + term1 * term2;
    b = usqr / 1024.0 * (256.0 + usqr * (-128.0 + usqr * (74.0 - 47.0 * usqr))); // eq 4
    ...
    do
    {
        ...
        deltasigma = b * ss * (c2sm + b / 4.0 * (cs * (-1.0 + 2.0 * sqr(c2sm)) - b / 6.0 * c2sm * (-3.0 + 4.0 * sqr(ss)) * (-3.0 + 4.0 * sqr(c2sm)))); // eq 6
    ...
    c = flat / 16.0 * sqr(cosalpha) * (4.0 + flat * (4.0 - 3.0 * sqr(cosalpha)));
