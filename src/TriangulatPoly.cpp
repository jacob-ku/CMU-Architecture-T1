...
static bool intersect(pfVec3 *p, int n, int i1, int i2)
{
	...
	return ccw(p[s1][0], p[s1][1], p[i1][0], p[i1][1], p[s2][0], p[s2][1]) != ccw(p[s1][0], p[s1][1], p[i1][0], p[i1][1], p[i2][0], p[i2][1]) && ccw(p[s2][0], p[s2][1], p[i2][0], p[i2][1], p[s1][0], p[s1][1]) != ccw(p[s2][0], p[s2][1], p[i2][0], p[i2][1], p[i1][0], p[i1][1]);
}
//---------------------------------------------------------------------------
static bool ccw(double p1x, double p1y, double p2x, double p2y, double p3x, double p3y)
{
